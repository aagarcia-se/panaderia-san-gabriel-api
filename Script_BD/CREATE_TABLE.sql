...
-- Tabla DescontarProductos
CREATE TABLE IF NOT EXISTS DESCUENTODESTOCK (
    idDescuento INTEGER PRIMARY KEY AUTOINCREMENT,
    idSucursal INTEGER NOT NULL,
    idUsuario INTEGER NOT NULL,
    tipoDescuento TEXT NOT NULL CHECK(tipoDescuento IN ('MAYOREO', 'MAL ESTADO', 'CORRECCION')),
...
-- Tabla DETALLESDESCONTARPRODUCTOS
CREATE TABLE IF NOT EXISTS DETALLEDESCUENTODESTOCK (
    idDetalleDescuento INTEGER PRIMARY KEY AUTOINCREMENT,
    idDescuento INTEGER NOT NULL,
    idProducto INTEGER NOT NULL,
    unidadesSobrantes INTEGER NOT NULL,
    fechaDescuento DATETIME NOT NULL,
    FOREIGN KEY (idDescuento) REFERENCES DESCUENTODESTOCK(idDescuento) ON DELETE CASCADE,
    FOREIGN KEY (idProducto) REFERENCES PRODUCTOS(idProducto) ON DELETE CASCADE
);
